...
with tab1:
    ...
    if uploaded_file is not None and AI_ENABLED:
        ...
        if st.button("AI Se Beemari Pocho 🧠"):
            with st.spinner("AI photo check kar raha hai..."):
                prompt = """Tum Pakistan ke Kissan Ustad ho. Is fasal ke patte/phal ki photo dekho. 
...
if df.empty: # <-- YE THEEK LINE HAI AB
